...
private slots:
    ...
    * Update frame slot
    */
   void updateFrame(const gstar::Array* imageData);
    ...
    */
   void updateColorTransferFunction(gstar::ColorTransferFunction ctf);
...
private:
    ...
    * Widget for CTF
    */
   gstar::ColorTransferFunctionEditor* m_colorTransferFunctionEditorWidget;
    ...
    * ROI table model
    */
   gstar::ROITableModel* m_roiTableModel;
