...
ScanConditionCommand::ScanConditionCommand(const std::shared_ptr<ScanConditionCommand>& rhs)
{
...
ScanConditionCommand& ScanConditionCommand::operator=(
   const std::shared_ptr<ScanConditionCommand>& rhs)
{
...
void ScanConditionCommand::addCommand(const std::shared_ptr<ScanCommand>& command)
{
...
void ScanConditionCommand::reset()
{
