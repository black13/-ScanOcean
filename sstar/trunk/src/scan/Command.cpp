                 ...
                 int postDelay)
{
   ...
   init(pv, op, SSTAR_INT, value, 0, 0.0, "", postDelay);
                 ...
                 int postDelay)
{
   ...
   init(pv, op, SSTAR_UINT, 0, value, 0.0, "", postDelay);
                 ...
                 int postDelay)
{
   ...
   init(pv, op, SSTAR_DOUBLE, 0, 0, value, "", postDelay);
                 ...
                 int postDelay)
{
   ...
   init(pv, op, SSTAR_STRING, 0, 0, 0, value, postDelay);
...
const int Command::getPostDelay() const
{
