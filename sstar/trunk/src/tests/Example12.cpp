...
void Example12::run()
{
   ...
   p_preScan->addCommand(m_name + ":Nexus1:FileName", "dummy", Command::PV_PUT_ASYNC);
   p_preScan->addCommand(m_name + ":Nexus1:FileTemplate", "%s%s.h5", Command::PV_PUT_ASYNC);
   p_preScan->addCommand(m_name + ":Nexus1:FileWriteMode", 2, Command::PV_PUT_ASYNC);
   p_preScan->addCommand(m_name + ":Nexus1:NumCapture", 100, Command::PV_PUT_ASYNC);
   p_preScan->addCommand(m_name + ":Nexus1:Capture", 1, Command::PV_PUT_ASYNC);
