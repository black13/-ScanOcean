...
public:
   ...
   CallbackParam(
      ...
      const std::shared_ptr<PVSpecificResources>& pSpecificResources,
      const std::shared_ptr<PVSharedResources>& pSharedResources,
   ...
   static const CallbackParam createAsynPutWithHandlerParam(
      ...
      std::shared_ptr<PVSpecificResources> pSpecificResources,
