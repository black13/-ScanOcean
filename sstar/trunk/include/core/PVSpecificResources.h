...
public:
    ...
    */
   std::condition_variable& getGetCV();
    ...
    * @return Condition variable
    */
   std::condition_variable& getPutCV();
    ...
    * @return Condition variable
    */
   std::condition_variable& getPendingRequestsCV();
...
private:
    ...
    */
   std::condition_variable m_synGetCV;

   /**
    * SynPut Condition Variable
    */
   std::condition_variable m_synPutCV;

   /**
    * Pending Requests condition variable
    */
   std::condition_variable m_pendingRequestsCompletionCV;
