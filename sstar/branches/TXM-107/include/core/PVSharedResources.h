...
public:
    ...
    */
   boost::condition_variable& getPutQueueEmptyCV();
    ...
    * @return Condition variable
    */
   boost::condition_variable& getConnectionCV();
...
private:
    ...
    */
   boost::condition_variable m_connectionCV;

   /**
    * Put queue empty condition variable
    */
   boost::condition_variable m_putQueueEmptyCV;
