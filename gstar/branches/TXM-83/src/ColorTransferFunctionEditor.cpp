...
void ColorTransferFunctionEditor::updateHistogramType(int type)
{

   m_red->updateHistogramType(type);
   m_green->updateHistogramType(type);
   m_blue->updateHistogramType(type);
