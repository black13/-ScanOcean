...
: QWidget(widget)
{
   ...
   m_validatorMin = new QIntValidator(0, 4095, this);
   m_validatorMax = new QIntValidator(0, 4095, this);
...
void ControlPointWidget::setPoints(const QPolygonF& points)
{

   m_ctrlPointPicker -> setPoints(points);
...
void ControlPointWidget::updateHistogramType(int type)
{

   m_histogram->updatePlotType(type);
