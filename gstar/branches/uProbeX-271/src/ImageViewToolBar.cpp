...

{
   ...
   m_imageWidget->setZoomPercentWidget(m_zoomPercent);
...
void ImageViewToolBar::clickFill()
{
   ...
   m_imageWidget->clickFill(m_fillAction->isChecked());
...
void ImageViewToolBar::clickZoomOriginal()
{
   ...
   m_imageWidget->clickZoomOriginal();
