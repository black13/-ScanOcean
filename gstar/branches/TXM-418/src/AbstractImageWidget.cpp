...
void AbstractImageWidget::addUProbeMarker()
{
...
void AbstractImageWidget::createActions()
{
   ...
   m_addUProbeMarkerAction = new QAction("Add UProbe Marker", this);
   ...
   connect(m_addUProbeMarkerAction,
           SIGNAL(triggered()),
           this,
           SLOT(addUProbeMarker()));
                                             ...
                                             const QPoint& pos)
{
   ...
   menu.addAction(m_addUProbeMarkerAction);
                                                     ...
                                                     annotation)
{
   ...
   int cCount = m_treeModel->columnCount();
   for(int i=0; i<cCount; i++)
   {
      m_annoTreeView->resizeColumnToContents(i);
   }
