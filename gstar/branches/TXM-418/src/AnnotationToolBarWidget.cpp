   ...
   QWidget(parent)
{
   ...
   m_uProbeMarkerAction =  new QAction(QIcon(":images/uprobe.png"),
                                      "uProbeMarker",
                                      NULL);
...
//   m_toolbar->addAction(m_intensityPieAction);
   ...
   m_toolbar->addAction(m_uProbeMarkerAction);
...
AnnotationToolBarWidget::~AnnotationToolBarWidget()
{
   ...
   if(m_uProbeMarkerAction != NULL)
   {
      delete m_uProbeMarkerAction;
      m_uProbeMarkerAction = NULL;
   }
...
void AnnotationToolBarWidget::setActionsEnabled(int state)
{
   ...
   m_uProbeMarkerAction->setEnabled(enabled);
