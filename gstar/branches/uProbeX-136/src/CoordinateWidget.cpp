...
//      m_lblPixelXCoordinate->setText(QString::number(dx, 'f', m_decimalPreci));
//      m_lblPixelYCoordinate->setText(QString::number(dy, 'f', m_decimalPreci));
   }
   else
   {
...
//      m_lblPixelXCoordinate->setText(QString::number(x, 'f', m_decimalPreci));
//      m_lblPixelYCoordinate->setText(QString::number(y, 'f', m_decimalPreci));
   }
...
void CoordinateWidget::setCoordinate(double x, double y, double z)
{
   ...
   if(m_model != NULL)
   {
      ...
      m_lblPixelXCoordinate->setText(QString::number(dx));
      m_lblPixelYCoordinate->setText(QString::number(dy));
      m_lblPixelYCoordinate->setText(QString::number(dz));

//      m_lblPixelXCoordinate->setText(QString::number(dx, 'f', m_decimalPreci));
//      m_lblPixelYCoordinate->setText(QString::number(dy, 'f', m_decimalPreci));
//      m_lblPixelZCoordinate->setText(QString::number(dz, 'f', m_decimalPreci));
   }
   else
   {
       m_lblPixelXCoordinate->setText(QString::number(x));
       m_lblPixelYCoordinate->setText(QString::number(y));
       m_lblPixelYCoordinate->setText(QString::number(z));
//      m_lblPixelXCoordinate->setText(QString::number(x, 'f', m_decimalPreci));
//      m_lblPixelYCoordinate->setText(QString::number(y, 'f', m_decimalPreci));
//      m_lblPixelZCoordinate->setText(QString::number(z, 'f', m_decimalPreci));
   }
...
//void CoordinateWidget::setCoordinatePrecision(int number)
//{
